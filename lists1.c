...
/**
 * list_len -This is going determine the length of the linked list
...
/**
 * list_to_strings - This is going to return an array of strings of the list->str
...
/**
 * node_starts_with - This will return the node whose string starts with prefix
