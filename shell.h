 ...
 * @num:here is the number field
 * @str:and here is a string
 ...
 * @arg: Here is a string generated from getline containing arguements
 * @argv:This is an array of strings generated from arg
 * @path:This is a string path for the current command
 * @argc:This is the argument count
 * @line_count:Here is the error count
 * @err_num:Here is the error code for exit()s
 * @linecount_flag: if on count this line of input
 * @fname:Here is the program filename
 * @env:The linked list local copy of environ
 * @environ:THE custom modified copy of environ from LL env
 * @history:The the history node
 * @alias:This is the alias node
 * @env_changed: on if environ was changed
 * @status: the will return status of the last exec'd command
